...
模块结构：
  ...
  Part 3: BASIC_FACTORS + 分类映射 （20 个因子原子基元，GP 种子质量保障）

使用方式：
  >>> from factor.v3.formulas import ALPHA101, ALPHA191, BASIC_FACTORS
  >>> len(ALPHA101)      # 101
  >>> len(ALPHA191)      # 171（20 个预留）
  >>> len(BASIC_FACTORS) # 20
