"""
signals/v4/engine.py — 统一回测引擎 (ft2.core 驱动)
=============================================================================
v4 核心设计: 探索、测试、回测三个阶段全部走 ft2.core Engine。
...
用法:
  ...
  # 对称: signal>0 做多
  analyzer = EngineCore.backtest(signal, data, mode='fast')

  # 非对称: BUY/SELL 完全独立
  analyzer = EngineCore.backtest_stateful(
...
class EngineCore:
    ...
    def backtest_stateful(
        ...
        这是 EngineCore 的核心入口: BUY 和 SELL 完全解耦，
        ...
        return EngineCore.backtest(signal, data, symbol, freq, initial_capital,
